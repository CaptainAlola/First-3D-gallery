...
class Asset(models.Model):
    ...
    # Поле для файла. upload_to указывает подпапку, куда сохранять файлы.
    # Внимание: Файл не ложится в базу! В базе лежит путь "3d_assets/имя_файла.glb"
    file = models.FileField(upload_to='3d_assets/', verbose_name="3D Файл")
    # --- НОВОЕ ПОЛЕ ---
    # Будем хранить автоматическую миниатюру. Поле может быть пустым (при ошибке генерации).
